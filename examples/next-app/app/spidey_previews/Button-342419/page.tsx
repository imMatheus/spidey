...
import { Button as Spidey_Component } from "../../../components/Button";

const RAW_PROPS = {"label":"dignissimos capio deprimo","onClick":"__spidey_noop__"} as Record<string, unknown>;
